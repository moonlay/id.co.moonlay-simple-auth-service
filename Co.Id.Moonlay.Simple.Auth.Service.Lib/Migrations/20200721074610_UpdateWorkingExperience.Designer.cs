...
namespace Co.Id.Moonlay.Simple.Auth.Service.Lib.Migrations
{
    ...
    [Migration("20200721074610_UpdateWorkingExperience")]
    partial class UpdateWorkingExperience
    {
            ...
            modelBuilder.Entity("Co.Id.Moonlay.Simple.Auth.Service.Lib.Models.AccountProfile", b =>
                {
                    ...
                    b.HasOne("Co.Id.Moonlay.Simple.Auth.Service.Lib.Models.EducationInfo", "EducationInfo")
                        .WithMany()
                        .HasForeignKey("EducationInfoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Co.Id.Moonlay.Simple.Auth.Service.Lib.Models.FamilyData", "Family")
                        .WithMany()
